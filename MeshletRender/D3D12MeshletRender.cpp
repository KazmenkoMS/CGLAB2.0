...
const wchar_t* D3D12MeshletRender::c_meshFilename = L"..\\Assets\\head2.bin";
...
void D3D12MeshletRender::OnUpdate()
{
	...
	XMMATRIX world = XMMatrixScaling(30.0f, 30.0f, 30.0f) * XMMatrixTranslation(0.0f, 50.0f, -100.0f);
